...
main(int argc, char *argv[])
{
  ...
  25:	e8 cb 02 00 00       	call   2f5 <unlink>
  ...
  42:	c7 44 24 04 8a 07 00 	movl   $0x78a,0x4(%esp)
  49:	00 
  ...
  5f:	90                   	nop
    printf(2, "Usage: rm files...\n");
  60:	c7 44 24 04 76 07 00 	movl   $0x776,0x4(%esp)
  67:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38a:	f7 f7                	div    %edi
 38c:	0f b6 92 aa 07 00 00 	movzbl 0x7aa(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 538:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        if(s == 0)
 53b:	b9 a3 07 00 00       	mov    $0x7a3,%ecx
        s = (char*)*ap;
...
free(void *ap)
{
 ...
 601:	a1 c4 07 00 00       	mov    0x7c4,%eax
{
 ...
 64f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 651:	a3 c4 07 00 00       	mov    %eax,0x7c4
}
 656:	5b                   	pop    %ebx
 657:	5e                   	pop    %esi
 658:	5f                   	pop    %edi
 ...
 67b:	89 10                	mov    %edx,(%eax)
  freep = p;
 67d:	a3 c4 07 00 00       	mov    %eax,0x7c4
}
 682:	5b                   	pop    %ebx
 683:	5e                   	pop    %esi
 684:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 699:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 69c:	8b 0d c4 07 00 00    	mov    0x7c4,%ecx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 6d0:	3b 05 c4 07 00 00    	cmp    0x7c4,%eax
 ...
 6ef:	89 58 04             	mov    %ebx,0x4(%eax)
      freep = prevp;
 6f2:	89 0d c4 07 00 00    	mov    %ecx,0x7c4
      return (void*)(p + 1);
 ...
 732:	e8 c9 fe ff ff       	call   600 <free>
  return freep;
 737:	8b 0d c4 07 00 00    	mov    0x7c4,%ecx
      if((p = morecore(nunits)) == 0)
 ...
 74c:	eb a4                	jmp    6f2 <malloc+0x62>
    base.s.ptr = freep = prevp = &base;
 74e:	c7 05 c4 07 00 00 bc 	movl   $0x7bc,0x7c4
 755:	07 00 00 
    base.s.size = 0;
 758:	b9 bc 07 00 00       	mov    $0x7bc,%ecx
    base.s.ptr = freep = prevp = &base;
 75d:	c7 05 bc 07 00 00 bc 	movl   $0x7bc,0x7bc
 764:	07 00 00 
    base.s.size = 0;
 767:	c7 05 c0 07 00 00 00 	movl   $0x0,0x7c0
 76e:	00 00 00 

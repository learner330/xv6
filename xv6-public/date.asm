...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39a:	f7 f7                	div    %edi
 39c:	0f b6 92 cf 07 00 00 	movzbl 0x7cf(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 548:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        if(s == 0)
 54b:	b9 c8 07 00 00       	mov    $0x7c8,%ecx
        s = (char*)*ap;
...
free(void *ap)
{
 ...
 611:	a1 e8 07 00 00       	mov    0x7e8,%eax
{
 ...
 65f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 661:	a3 e8 07 00 00       	mov    %eax,0x7e8
}
 666:	5b                   	pop    %ebx
 667:	5e                   	pop    %esi
 668:	5f                   	pop    %edi
 ...
 68b:	89 10                	mov    %edx,(%eax)
  freep = p;
 68d:	a3 e8 07 00 00       	mov    %eax,0x7e8
}
 692:	5b                   	pop    %ebx
 693:	5e                   	pop    %esi
 694:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 6ac:	8b 0d e8 07 00 00    	mov    0x7e8,%ecx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 6e0:	3b 05 e8 07 00 00    	cmp    0x7e8,%eax
 ...
 6ff:	89 58 04             	mov    %ebx,0x4(%eax)
      freep = prevp;
 702:	89 0d e8 07 00 00    	mov    %ecx,0x7e8
      return (void*)(p + 1);
 ...
 742:	e8 c9 fe ff ff       	call   610 <free>
  return freep;
 747:	8b 0d e8 07 00 00    	mov    0x7e8,%ecx
      if((p = morecore(nunits)) == 0)
 ...
 75c:	eb a4                	jmp    702 <malloc+0x62>
    base.s.ptr = freep = prevp = &base;
 75e:	c7 05 e8 07 00 00 e0 	movl   $0x7e0,0x7e8
 765:	07 00 00 
    base.s.size = 0;
 768:	b9 e0 07 00 00       	mov    $0x7e0,%ecx
    base.s.ptr = freep = prevp = &base;
 76d:	c7 05 e0 07 00 00 e0 	movl   $0x7e0,0x7e0
 774:	07 00 00 
    base.s.size = 0;
 777:	c7 05 e4 07 00 00 00 	movl   $0x0,0x7e4
 77e:	00 00 00 
